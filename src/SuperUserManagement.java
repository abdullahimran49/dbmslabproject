...
public class SuperUserManagement extends JPanel {
    ...
    public SuperUserManagement() {
        ...
        JButton addUserBtn = new JButton("Add User/Admin");
        JButton deleteUserBtn = new JButton("Delete Selected");

        addUserBtn.addActionListener(e -> addUserOrAdmin());
        deleteUserBtn.addActionListener(e -> deleteUserOrAdmin());
    ...
    private void loadUsers() {
        ...
        try (Connection conn = DBConnection.getConnection();
             CallableStatement cs = conn.prepareCall("{call sp_GetUsers}");
    ...
    private void addUserOrAdmin() {
        ...
        while (true) {
            int result = JOptionPane.showConfirmDialog(this, panel, "Add New User/Admin",
            ...
            try (Connection conn = DBConnection.getConnection();
                ...
                JOptionPane.showMessageDialog(this, "Error adding " + role.toLowerCase() +
    ...
    private void deleteUserOrAdmin() {
        ...
        // Prevent deletion of another super admin
        if (role.equalsIgnoreCase("SuperAdmin")) {
            JOptionPane.showMessageDialog(this, "You cannot delete another SuperAdmin.",
                    "Access Denied", JOptionPane.WARNING_MESSAGE);
            return;
        }

        int confirm = JOptionPane.showConfirmDialog(this,
                "Are you sure you want to delete " + role.toLowerCase() + " '" + userName + "'?",
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try (Connection conn = DBConnection.getConnection();
                ...
                JOptionPane.showMessageDialog(this, "Error deleting " + role.toLowerCase() +
                        ": " + ex.getMessage(), "Database Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
